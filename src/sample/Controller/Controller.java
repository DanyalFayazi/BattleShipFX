...
import sample.Model.PlayerGrid;
...
public class Controller implements Initializable {
    ...
    sample.Model.PlayerGrid playerGrid;
    sample.Model.PCGrid pcGrid;
    ...
    private sample.Model.AI ai = new sample.Model.AI();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        playerGrid = new sample.Model.PlayerGrid(playerDisplayBoard);
        pcGrid = new sample.Model.PCGrid(pcDisplayBoard);
        reset();
    }
    ...
    private void installBoatListeners(Node boat) {
        ...
        boat.setOnMousePressed(mouseEvent -> {
            ...
            sample.Model.Ship removeShip = null;
            for (sample.Model.Ship ship : playerGrid.ships) {
     ...
     */
    void installPCBoardListeners(sample.Model.PCGrid grid) {
        for (Node node : pcDisplayBoard.getChildren()) {
            Rectangle rect = (Rectangle) node;
        ...
        anchor.setOnMouseDragged(event -> {
            ...
            anchor.setOnMouseReleased(event2 -> {
                ...
                if (playerDisplayBoard.contains(localX, localY)) {
                    ...
                    sample.Model.Ship ship = new sample.Model.Ship(size, x, y, endX, endY);
